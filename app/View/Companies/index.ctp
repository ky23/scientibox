	...
	<table class="table table-hover"> 
		...
		<tbody>
			...
			<tr class="<?php echo ($i % 2) ? 'colored' : 'uncolored' ?>">
				...
				<td><?php echo ($companies[$i]['Event']['date']) ? $companies[$i]['Event']['date'] : 'Pas encore inscrit'; ?></td>
				<td><?php echo $companies[$i]['Company']['contact']; ?></td>
				<td><?php echo Configure::read('Dictionary.' . $companies[$i]['Company']['status']); ?></td>
