      ...
      <div class="form-group">
       ...
       <div class="form-group">
        <?php echo $this->Form->input('Company.contact', array(
          'type' => 'text',
          'label' => 'Contact principal : <span class="glyphicon glyphicon-asterisk required"/>',
          'class' => 'form-control',
                     ...
                     <div class="form-group">
                      ...
                      <div class="form-group">
                        <?php echo $this->Form->input('kbis_file', array(
                          'type' => 'file',
                          'id' => 'kbis_file',
                          'label' => 'Extrait Kbis de la société de moins de 3 mois: <span class="glyphicon glyphicon-asterisk required"/>'
                          )); ?>
                        </div> <!-- end of form-group -->
                        <div class="form-group">
                        ...
                        <div class="documents"> 
                         <div class="form-group"> 
                          <h3 class="span8 pull-left title">Structure du capital à date</h3> 
                        </div> <!-- end of form-group -->
                        <div class="form-group">
